...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-162143430-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-162143430-1');
</script>
          ...
          <ul class="timeline">
            ...
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Receive payment reminders and invoices to their mobile phones. Client can make payments directly by cash (Pay Near Me) or debit/credit card.</p>
                </div>
              </div>
            </li>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <p class="item-intro text-muted">Last Updated: May 5, 2019</p>
                <p><hr/></p>
