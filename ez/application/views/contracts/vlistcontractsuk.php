...
$(document).ready(function() {
  ...
  $('#contracts').DataTable( {
    ...
    "serverSide": true,
    "ajax": {
      url: '<?php echo base_url()?>' + 'C_contracts/contract_table_listuk',
      type: 'POST',
      data: default_data
    },
    "columnDefs": [ {
...
function edit_tools(contract, balance_status) {
  ...
  return button + button_style + menu + edit + addnote + update_amount + update_invoice + send_balance_link + reset_password + delete_contract + close_button
}
