    ...
    <div class="row">
      <div class="col-3">
        <div class="vertical-menu">
          ...
          <a  class="active" href="<?php echo base_url('C_contracts/newpaymentsf')?>">Contract Monthly Payments</a>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('C_contracts/newpayment');?>",
      type: 'POST',
    ...
    $.ajax({
      ...
      url: "<?php echo site_url('C_contracts/totalpaymentmensual');?>",
      type: 'POST',
      success:function(response){

  
          
         $("#total").text("Total monthly payments $" + new Intl.NumberFormat().format(response));
    ...
    $.ajax({
      ...
      url: "<?php echo site_url('C_contracts/totalpaypromedio');?>",
      type: 'POST',
      success:function(response){

  
          
         $("#promedio").text("Average $" + new Intl.NumberFormat().format(response));
...
function excel(){
  ...
  window.location.href = "https://ezlawpay.com/ez/C_reports/download_excelpayments?mes="+mes+"&year="+year+"";
