    ...
    <div class="row">
      <div class="col-3">
        <div class="vertical-menu">
          ...
          <a  class="active" href="<?php echo base_url('C_contracts/newcontracts')?>">New Contracts</a>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('C_contracts/newcontractsjax');?>",
      type: 'POST',
    ...
    function totaprom(){
      $.ajax({
      url: "<?php echo site_url('C_contracts/totalmescon');?>",
      type: 'GET',
      success:function(response){

            var nuevonumero = Number.parseFloat((parseInt(response, 10)/fechas.length)).toFixed(2);  
          $("#total").text("New Contracts : " + new Intl.NumberFormat().format(response));
    ...
    function totaprom(){
      ...
      success:function(response){
         ...
         var nuevonumero = Number.parseFloat((parseInt(response, 10)/cantidaddd)).toFixed(2);  
          $("#total").text("New Contracts : " + new Intl.NumberFormat().format(response));
          $("#promedio").text("Average : " +nuevonumero);
...
function excel(){
  ...
  window.location.href = "https://ezlawpay.com/ez/C_reports/download_excelnewcontract?mes="+mes+"&year="+year+"";
