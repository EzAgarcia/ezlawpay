    ...
    <div class="row">
      <div class="col-3">
        <div class="vertical-menu">
          ...
          <a class="active" href="<?php echo base_url('C_contracts/totalincome')?>">Total Income</a>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('C_contracts/totalincomeajax');?>",
      type: 'POST',
    ...
    $.ajax({
      url: "<?php echo site_url('C_contracts/totalmes');?>",
      type: 'GET',
      success:function(response){

         $("#total").text("Total Income: $" + new Intl.NumberFormat().format(response));
...
function excel(){
  ...
  window.location.href = "https://ezlawpay.com/ez/C_reports/download_excelincome?mes="+mes+"&year="+year+"";
...
//   window.location.href = "http://ezlawpay.com/ez/C_reports/download_excelincome?mes="+mes+"&year="+year+"";
