      ...
      <div class="col-3">
        <div class="vertical-menu">
         <a href="<?php echo base_url('statistics')?>" >Contract Status</a>
          ...
          <a  class="active" href="<?php echo base_url('C_contracts/paymentshold')?>">Contracts no payments </a>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('C_contracts/nopayments');?>",
      type: 'POST',
    ...
    function totaprom(){
      $.ajax({
      url: "<?php echo site_url('C_contracts/nopaymenttt');?>",
      type: 'GET',
      success:function(response){

            var nuevonumero = Number.parseFloat((parseInt(response, 10)/fechas.length)).toFixed(2);  
          $("#total").text("Contracts that have not made payments : " + new Intl.NumberFormat().format(response));
...
function exceltype(){
  ...
  var inicio = cadena.substr(6,4)+'-'+cadena.substr(0,2)+'-'+cadena.substr(3,2)+' 00:00:00';
  var fin = cadena.substr(19,4)+'-'+cadena.substr(13,2)+'-'+cadena.substr(16,2)+' 23:59:59';
