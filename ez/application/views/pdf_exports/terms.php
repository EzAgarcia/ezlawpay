          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <div class = "right-box">
                    ...
                    <tbody>
                        <tr class="client-info">
                            ...
                            <td class="row-info" style="font-size: 15px;">Date: <?php echo date("m") . "/" . date("d") . "/" . date("Y"); ?></td>
                        </tr>
                    </tbody>
                    </table>
                </div>
                <br>
                <br>
                <!--  <p style="margin-right: 0%!important">Date: <?php echo date("m") . "/" . date("d") . "/" . date("Y"); ?></p> -->

                        <div class="row">

                        <input style="margin-left: 25%:" name="checkbox" class="form-check-input big-checkbox" type="checkbox" value="1" id="invalidCheck" checked>
                        ...
                        <center><input name="firma" id="firm" style="text-align:center; border: 0;outline: 0;border-bottom: 2px solid #000000;outline:none !important;outline-width: 0 !important;box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none; width: 45%; margin: auto;" type="text" class="form-control" value="<?php echo $name; ?>" required="required"></center>
