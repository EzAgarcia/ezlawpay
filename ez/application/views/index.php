...
<head>
  ...
  <meta name="keywords" content="Financial Management, Law Firm, Financial solution">

  <title>EZ Law Pay: Every Payment, Every Time | Electronic Payments Platform</title>
...
@media (max-width: 337px) {
 ...
 -->
<body id="page-top" class="b">
  <!-- Navigation -->



  <nav class="navbar navbar-expand-lg navbar-dark fixed-top nuevaclase" id="mainNav">
    <div class="container">
      <a href="/"><img src="<?php echo base_url() ?>assets/img/WhiteOnTransparent.png" alt="Ez Law Pay"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
           <!-- <a class="nav-link js-scroll-trigger" href="<?php echo site_url('login'); ?>">Make a payment</a> -->
          </li>
        </ul>
      </div>
    </div>
...
<!-- <nav id="covid" class="navbar navbar-expand-lg navbar-dark fixed-top text-center col-sm-12" style="position: fixed; margin-top: 0%; background-color: #E8E76F; font-size: 13.5px;">
  <center>We at Ez Law Pay have been mindful of the Coronavirus (covid-19) and continue to monitor the situation closely. We know that many of our customers may be facing financial challenges during this time and we want to help. In addition to complying with any state mandated actions, we are offering a free trial for April & May 2020 to both new and existing customers.                                                   Existing customer will continue to recieve team support and have no interuptions with their service without a charge. All new customers please fill out our contact form and one of our representatives will be reaching out to you for further information.</center>
</nav> -->
  ...
  <header class="masthead"> <!-- masthead -->
    <div class="container">
      <div class="intro-text vamosxz" style="margin-top: 2rem">
        <div class="intro-lead-in">Financial Management</div>
        <div class="col-md-5">EZ Law Pay is a complete financial management solution for your law firm, providing the tools you need to improve organization, increase efficiency and scale your firm operations. With Ez Law Pay, all your important financial operations are all available in a single location thus improving time management and profit increment.
          <p class="text-muted text-justify"></p>
        </div>
        <!-- <div class="intro-heading text-uppercase">Financial Management Software</div> -->
  ...
  <span class="ir-arriba"><img src="<?php echo base_url() ?>assets/img/ArrowUp.png" alt=""></span>
  ...
  <section id="services">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-6">
          <h5 class="service-heading text-left">Reports & Analytics</h5>
          <h6 class="service-heading text-left">You can't manage what you can't measure...</h6>
          <p class="text-muted text-justify">EZ Law Pay's dashboard analytics makes it easier than ever to know the health of your business in an instant and at a glance. Track and monitor the essential metrics that are important to the performance of your practice.</p>
          <p class="text-muted text-justify">The key to managing a successful business is keeping track of the crucial financial data and insights that will assist your decision making. At EZ Law Pay we deliver real time data with comprehensive reports and key analytics throughout the interface to help you better understand the business side of your practice.</p>
        </div>
        <div class="col-md-6">
          <img class="img-fluid mx-auto" src="<?php echo base_url() ?>assets/img/lapA.jpg" alt="">
        </div>
      </div>
      </br></br>
      <div class="row">
        <div class="col-md-6">
          <h5 class="service-heading text-left">Simplified Billing & Invoicing</h5>
          <p class="text-muted text-justify">
            <ul>
              <li>print or email customized invoices</li>
              <li>easily create and edit batch invoices</li>
            </ul></p>
        </div>
        <div class="col-md-6">
          <h5 class="service-heading text-left">Integrate your Merchant:</h5>
          <p class="text-muted text-justify">EZ Law Pay can integrate with any merchant making it easy to use only one platform but reflect all of your clients payments within both programs. Having your clients pay thru your merchant and automatically transferring data will save you the hassle of manual capturing thus saving you time, money and errors.</p>
        </div>
      </div>
      </br></br>
      <div class="row">
        <div class="col-md-12">
          <h5 class="service-heading text-left">We'll help you keep track so you can focus on what's important!</h5>
        </div>
      </div>
    </div>
  </section>
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url() ?>assets/img/icono2.png" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>1</h4>
                  <h4 class="subheading">Law firm</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">Needs to improve or establish a well financial management system.</p>
                </div>
              </div>
            </li>
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url() ?>assets/img/icono.png" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>2</h4>
                  <h4 class="subheading">Ez Law Pay</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">Evaluates the platform that best adapts to the law firm needs and creates its profile.</p>
                </div>
              </div>
            </li>
            <li>
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Creates different users within their profile [Authorized User, Read-Only User, Client Profile]</p>
                </div>
              </div>
            </li>
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url() ?>assets/img/icono3.png" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>4</h4>
                  <h4 class="subheading">Clients</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">Receive payment reminders and invoices to their mobile phones. </p>
                </div>
              </div>
            </li>
            <li class="timeline-image">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Processes payment received by cash, card threw software. Has the ability to create financial reports.</p>
                </div>
              </div>
            </li>
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="<?php echo base_url() ?>assets/img/icono4.png" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>6</h4>
                  <h4 class="subheading">Winner / Law Firm</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">Law Firm sees a increment of income with a efficient financial administration.</p>
                </div>
              </div>
            </li>
          </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h3 class="service-heading">ABOUT US</h3>
        </div>
      </div>

      <center>
      <div class="col-md-8 text-center">
          <p>To provide an excellent service in order to increase the efficiency of financial administration through a software especially designed for small and medium law firms.</p>
        </div>
     </center>
     ...
     <br><br>
      ...
      <div class="row">
        <div class="col-md-6 text-center">
          <center>
        <div class="col-8">
                    <h5 class="text-muted">Our Mission</h5>
          <p>To provide an excellent service in order to increase the efficiency of financial administration through a software especially designed for small and medium law firms.</p>
        </div>
        </center>
        </div>
        ...
        <div class="col-md-6 text-center">
          <center>
          <div class="col-8">
          <h5 class="text-muted">Our vision</h5>
          <p>Provide software that helps law firms have greater growth through good management of their resources.</p>
        </div>
  ...
  <section id="make">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h5 class="service-heading">Make the Switch with Peace of Mind</h5>
        </div>
      </div>
      </br></br>
      <div class="row">
        <div class="col-md-4 text-center">
          <img class="img-fluid mx-auto" src="<?php echo base_url() ?>assets/img/migrations.png" alt="">
          <h6 class="text-muted">Complementary Data Migrations</h6>
        </div>
        <div class="col-md-4 text-center">
          <img class="img-fluid mx-auto" src="<?php echo base_url() ?>assets/img/support.png" alt="">
          <h6 class="text-muted">World Class Support</h6>
        </div>
        <div class="col-md-4 text-center">
          <img class="img-fluid mx-auto" src="<?php echo base_url() ?>assets/img/security.png" alt="">
          <h6 class="text-muted">Industry Leading Security</h6>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="make">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h5 class="service-heading">Our integrations</h5>
        </div>
      </div>
      </br></br>
      <div class="row">
        ...
        <div class="col-md-5 text-center">
          <img class="img-fluid mx-auto" width="280px" height="130px" src="<?php echo base_url() ?>assets/img/square.png" alt="">
          <br>
          <br>
          <a href="https://youtu.be/NfCFAsJsNp8" target="_blank"><button class="btn btn-info">Watch a Short Video</button></a>

        </div>
        <div class="col-md-5 text-center">
          <img class="img-fluid mx-auto" style="margin-top: -5%" width="400px" height="70%" src="<?php echo base_url() ?>assets/img/eztexting.png" alt="">
          <br>
           <a href="https://www.youtube.com/watch?v=7IJNp0C7XD8&feature=emb_logo" target="_blank"><button style="margin-top: 6px;" class="btn btn-info">Watch a Short Video</button></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted" style='color: white !important;'>Do you need more information?</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
      ...
      <div class="row" style="color: white;">
          <div class="col-lg-4 address-address">

          </div>
          <div class="col-lg-4 address-mail">
            <p><i class="fa fa-envelope"></i>&nbsp;&nbsp;info@ezlawpay.com</p>
          </div>
          <div class="col-lg-4 address-phone">
            <p><i class="fa fa-phone"></i>&nbsp;&nbsp;+1 (747)205-3022</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <span class="copyright">Copyright &copy; EZ Law Pay <?php echo date('Y'); ?></span>
        </div>
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            <li class="list-inline-item">
              <a href="https://twitter.com/Ezlawpay" target="_blank">
                <i class="fab fa-twitter"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="https://www.facebook.com/Ezlawpay-110582287255457" target="_blank">
        ...
        <div class="col-md-4">
          <ul class="list-inline quicklinks">
            ...
            <li class="list-inline-item">
              <a data-toggle="modal" href="#portfolioModal2">Terms and Conditions</a>
            </li>
            <li class="list-inline-item">
              <a data-toggle="modal" href="#portfolioModal3">Disclaimer's</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <p class="item-intro text-muted">Effective date: Aug 26, 2020</p>
                <p><hr/></p>
                <p class="text-justify"><strong>Ez Law Pay ("us", "we", or "our") operates the www.ezlawpay.com website (the "Service").</strong></p>
                <p class="text-justify">This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
                <p class="text-justify">We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from <a href="www.ezlawpay.com">www.ezlawpay.com</a></p>
                <p class="text-justify">We do not sell or rent your personal information or the information of your clients to third parties for their marketing purposes. Please read this privacy policy to learn more about the ways in which we use and protect your personal information or the information of your clients. We want you to fully understand our privacy practices.</p>
                <p class="text-justify">This Privacy Policy describes the information, as part of the normal operation of our services, we collect from you and what may happen to that information. Although this policy may seem long, we have prepared a detailed policy, because we believe you should know as much as possible about our practices, so that you can make informed decisions. By accepting the Privacy Policy and any other agreement presented to you on the Site, you expressly consent to our use and disclosure of your personal information in accordance with this Privacy Policy. This Privacy Policy is effective upon your acceptance of the policy during registration for new registering users, and is otherwise effective on April 11, 2019 for all users.</p>
                <h4 class="text-left">Information Collection And Use</h4>
                <p class="text-justify">We collect several different types of information for various purposes to provide and improve our Service to you.</p>
                <h5 class="text-left">Types of Data Collected</h5>
                <p class="text-left">Personal Data</p>
                <p class="text-justify">While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to:</p>
                <p>
                  <ul class="text-left">
                    <li>Email address</li>
                ...
                <p class="text-left">Usage Data</p>
                <p class="text-justify">We may also collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>
                <p class="text-left">Tracking & Cookies Data</p>
                <p class="text-justify">We use cookies and similar tracking technologies to track the activity on our Service and hold certain information.</p>
                <p class="text-justify">Cookies are files with small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. Tracking technologies also used are beacons, tags, and scripts to collect and track information and to improve and analyze our Service.</p>
                <p class="text-justify">You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service.</p>
                <p class="text-justify">Examples of Cookies we use:</p>
                <p>
                  <ul class="text-left">
                ...
                <h4 class="text-left">Use of Data</h4>
                <p class="text-justify">Ez Law Pay uses the collected data for various purposes:</p>
                <p>
                  <ul class="text-left">
                ...
                <h4 class="text-left">Transfer Of Data</h4>
                <p class="text-justify">Your information, including Personal Data, may be transferred to — and maintained on — computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from your jurisdiction.</p>
                <p class="text-justify">If you are located outside United States and choose to provide information to us, please note that we transfer the data, including Personal Data, to United States and process it there.</p>
                <p class="text-justify">Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
                <p class="text-justify">Ez Law Pay will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                <h4 class="text-left">Disclosure Of Data</h4>
                <h5 class="text-left">Legal Requirements</h5>
                <p class="text-justify">Ez Law Pay may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <p>
                  <ul class="text-left">
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Ez Law Pay</li>
                ...
                <p class="text-justify">This website takes every precaution to protect your information. When you submit sensitive information via the website, your information is protected both online and off-line. Information is transmitted using SSL encryption and our website and associated web pages are hosted in Payment Card Industry Data Security Standard (PCI DSS) compliant environment(s).</p>
                <h4 class="text-left">Service Providers</h4>
                <p class="text-justify">We may employ third party companies and individuals to facilitate our Service ("Service Providers"), to provide the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used.</p>
                <p class="text-justify">These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.</p>
                <h5 class="text-left">Analytics</h5>
                <p class="text-justify">We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
                <p>
                  <ul class="text-left">
                    <li><strong>Google Analytics</strong></li>
                  </ul>
                </p>
                <p class="text-justify">Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network.</p>
                <p class="text-justify">You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js, and dc.js) from sharing information with Google Analytics about visits activity.</p>
                <p class="text-justify">For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
                <h4 class="text-left">Links To Other Sites</h4>
                <p class="text-justify">Our Service may contain links to other sites that are not operated by us. If you click on a third party link, you will be directed to that third party's site. We strongly advise you to review the Privacy Policy of every site you visit.</p>
                <p class="text-justify">We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                <h4 class="text-left">Children's Privacy</h4>
                <p class="text-justify">Our Service does not address anyone under the age of 18 ("Children").</p>
                <p class="text-justify">We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or guardian and you are aware that your Children has provided us with Personal Data, please contact us. If we become aware that we have collected Personal Data from children without verification of parental consent, we take steps to remove that information from our servers.</p>
                <h4 class="text-left">Changes To This Privacy Policy</h4>
                <p class="text-justify">We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
                <p class="text-justify">We will let you know via email and/or a prominent notice on our Service, prior to the change becoming effective and update the "effective date" at the top of this Privacy Policy.</p>
                <p class="text-justify">You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
                <h4 class="text-left">Contact Us</h4>
                <p class="text-justify">If you have any questions about this Privacy Policy, please contact us:</p>
                <p>
                  <ul class="text-left">
                    <li>By email: <a href="mailto:info@ezlawpay.com">info@ezlawpay.com</a></li>
                  </ul>
                </p>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <p class="text-justify">2.4 Authorized Users agree not to modify, reverse engineer, adapt or otherwise tamper with the Service or modify another website so as to falsely imply that it is associated with the Service, EZ Law Pay or any other software or service provided by EZ Law Pay.</p>
                ...
                <p class="text-justify">2.13 EZ Law Pay uses one code-base for all jurisdictions. Subscriber is required, using settings available within the Service, to configure the Service for its own jurisdiction and to verify that the settings meet the Subscriber’s requirements. EZ Law Pay will highlight known features that may require Subscriber review.</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h2 class="text-uppercase">Disclaimer's</h2>
                <!-- <p class="item-intro text-muted">Effective date: April 11, 2019</p> -->
                <p><hr/></p>
                <h4 class="text-left">WEBSITE DISCLAIMER</h4>
                <p class="text-justify">The information provided by EZ Law Pay (“we”, “us”, “our”) on <a href="www.ezlawpay.com">www.ezlawpay.com</a> (the “site”) and our mobile application is for general information purposes only. All information on the site and our mobile application is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability or completeness of any information on the site or our mobile application. UNDER NO CIRCUMSTANCES SHALL WE HAVE ANY LIABILITY TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF THE SITE OR OUR MOBILE APPLICATION PR RELIANCE ON ANY INFORMATION PROVIDED ON THE SITE AND OUR MOBILE APPLICATION. YOUR USE OF THE SITE AND OUR MOBILE APPLICATION AND YOUR RELIANCE ON ANY INFORMATION ON THE SITE AND OUR MOBILE APPLICATION IS SOLELY AT YOUR OWN RISK.</p>
                <h4 class="text-left">EXTERNAL LINKS DISCLAIMER</h4>
                <p class="text-justify">The site and our mobile application may contain (or you maybe sent through the site or mobile application) links to other websites or content belonging to or originating from third parties or links to websites and features in banners or other advertising. Such external links are not investigated, monitored, or checked for accuracy, adequacy, validity, reliability, availability or completeness by us. WE DO NOT WARRANT, ENDORSE, GUARANTEE OR ASSUME RESPONSIBILITY FOR THE ACCURACY OR RELIABILITY OF ANY INFORMATION OFFERED BY THE THIRD-PARTY WEBSITES LINKED THROUGH THE SITE OR ANY WEBSITE FEATURED LINKED IN ANY BANNER OR OTHER ADVERTISING. WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS AND SERVICES.</p>
                <h4 class="text-left">PROFESSIONAL DISCLAIMER</h4>
                <p class="text-justify">The site cannot and does not contain legal advice. The legal information is provided for general informational and educational purposes only and is not a substitute for professional advice. Accordingly, before taking any actions based upon such information, we encourage you to consult with the appropriate professionals. We do not provide any kind of legal advice. THE USE OR RELIANCE OF ANY INFORMATION CONTAINED ON THIS SITE OR OUR MOBILE APPLICATION IS SOLELY AT YOUR OWN RISK.</p>
                <!-- <ul class="list-inline">
                  <li>Date: January 2017</li>
                  <li>Client: Threads</li>
                  <li>Category: Illustration</li>
...
//         $("#baj").css("margin-top", "0px");
//         $("#mainNav").css("margin-top", "0px!important");
//          $("#baj").removeAttr("id");
//           $('.nuevaclase').removeClass('nuevaclase');
//           $("#down").removeAttr("id");
